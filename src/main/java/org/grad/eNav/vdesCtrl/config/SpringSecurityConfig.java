...
import org.grad.eNav.vdesCtrl.config.keycloak.KeycloakGrantedAuthoritiesMapper;
import org.grad.eNav.vdesCtrl.config.keycloak.KeycloakJwtAuthenticationConverter;
import org.grad.eNav.vdesCtrl.config.keycloak.KeycloakLogoutHandler;
...
class SpringSecurityConfig {
     ...
     */
    @Value("${spring.application.name:vdes-ctrl}")
    private String appName;

    /**
     * The default application name.
     */
    @Value("${gla.rad.vdes-ctrl.resources.open:/,/index,/webjars/**,/css/**,/lib/**,/images/**,/src/**}")
