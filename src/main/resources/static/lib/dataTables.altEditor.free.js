        ...
        altEditor.prototype,
        {
            ...
            _setup: function () {
                ...
                var modal = '<div class="modal fade altEditor-modal reveal" id="' + modal_id + '" tabindex="-1" role="dialog" data-reveal>' +
                    ...
                    '<button type="button" class="btn-close float-end" data-bs-dismiss="modal" aria-label="' + this.language.modalClose + '"></button>' +
                    '</div>' +
            ...
            _openDeleteModal: function () {
                ...
                var selector = this.modal_selector;
                var fill = function () {
                    var btns = '<button type="button" data-content="remove" class="btn btn-default button secondary" data-bs-close data-bs-dismiss="modal">' + that.language.modalClose + '</button>' +
